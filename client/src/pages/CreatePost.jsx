    ...
    if (form.prompt) {
      try {
        ...
        const response = await fetch(
          "http://localhost:8000/api/delle/generate",
          {
            method: "POST",
            headers: {
      ...
      <section className="max-w-7xl mx-auto">
        <div>
          ...
          <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
            Create imaginative and visually stunning images generated by Dell-E
            AI and share them with comunity
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-16 max-w-3xl">
          <div>
            ...
            <div className="mt-10">
              ...
              >
                {loading ? "sharing..." : "share with communiy"}
              </button>
            </div>
          </div>
        </form>
